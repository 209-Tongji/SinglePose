...
class DSPosev3(nn.Module):
    def __init__(self, cfg):
        super(DSPosev3, self).__init__()
        ...
        self.layer2 = Block(in_planes=32, out_planes=24, expansion=6, stride=2)
        self.layer3 = Block(in_planes=24, out_planes=32, expansion=6, stride=2)
        self.layer4 = Block(in_planes=32, out_planes=48, expansion=6, stride=2)
        self.layer5 = Block(in_planes=48, out_planes=256, expansion=6, stride=2)
        
        self.layer6 = DeconvBlock(in_planes=256, out_planes=256)
        self.layer7 = DeconvBlock(in_planes=256, out_planes=256)
        self.layer8 = DeconvBlock(in_planes=256, out_planes=256)
    ...
    def forward(self, x):
        ...
        x = self.layer5(x_layer4)
        x = self.layer6(x) + self.shortcut3(x_layer4)
        x = self.layer7(x) + self.shortcut2(x_layer3)
        x = self.layer8(x) + self.shortcut1(x_layer2)
        x = self.layer9(x)
